          ...
          >
            <div className="flex flex-col items-center justify-center space-y-3">
              <svg className="w-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g>
                  <path opacity="0.4" d="M12 7.75V13" stroke="#ff0000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>{' '}
                  <path
                  ...
                  ></path>{' '}
                  <path opacity="0.4" d="M12 16.2002V16.3002" stroke="#ff0000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>{' '}
                </g>
              </svg>
