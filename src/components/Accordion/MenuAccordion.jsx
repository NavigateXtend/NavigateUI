...
const code = `export default function MenuAccordion() {
    const accordionData = [
        {
            title: 'Profile',
            subTitle: [1, 2, 3, 4],
