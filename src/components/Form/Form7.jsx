    ...
    return (
        <CP code={code}>
            <div className="relative mx-auto flex w-80 items-center overflow-hidden bg-white shadow-xl md:w-96 lg:w-[800px]">
                ...
                <form className={`w-full p-8 ${register ? 'lg:translate-x-0' : 'hidden lg:block lg:-translate-x-full'} duration-500`}>
                    ...
                    <div className="space-y-5">
                        ...
                        <input
                            ...
                            placeholder=".............."
                            min={5}
                            className="block w-full rounded-md border p-3 outline-none valid:border-black invalid:border-red-700"
                        />
                    </div>
                    {/* button type will be submit for handling form submission*/}
                ...
                {/* img */}
                <div
                    className={`absolute top-0 z-50 hidden h-full w-1/2 overflow-hidden bg-black/20 duration-500 lg:block ${register ? 'translate-x-full rounded-bl-full duration-500' : 'rounded-br-full'}`}
                >
