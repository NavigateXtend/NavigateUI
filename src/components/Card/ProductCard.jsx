...
const code = `export default function ProductCard() {
    return (
      <div className="max-w-[350px] space-y-4 rounded-lg bg-white p-6 shadow-lg md:w-[350px] dark:bg-[#18181B]">
        <img width={200} height={200} className="h-[275px] w-[350px] rounded-lg object-cover" src="https://source.unsplash.com/200x200/?bed" alt="card navigate ui" />
...
export default function ProductCard(i) {
    return (
        <CP code={code} i={i}>
            <div className="mx-auto max-w-[350px] space-y-4 rounded-lg bg-white p-6 shadow-lg dark:bg-[#18181B] md:w-[350px]">
