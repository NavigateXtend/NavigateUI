...
const code = `export default function ProfileCard2() {
     return (
        <div className="flex flex-col items-center justify-center md:flex-row">
            <div className="group relative  sm:w-[350px]">
                <img width={350} height={350} className="h-full w-full scale-105 transform rounded-lg bg-black/70" src="https://source.unsplash.com/350x350/?men" alt="card navigate ui" />
...
export default function ProfileCard2() {
    return (
        <CP code={code} id="Profile Card 2">
            <div className="mx-auto flex flex-col items-center justify-center md:flex-row">
                ...
                <div className="min-w-[250px] max-w-[350px] space-y-12 rounded-br-lg rounded-tr-lg bg-white p-10 text-center shadow-[0px_7px_30px_2px_rgba(100,100,111,0.2)] dark:bg-[#18181B] dark:shadow-[0px_2px_8px_0px_rgba(0,0,0,0.8)] md:w-[350px]">
                    <div className="space-y-1">
                        <h2 className="text-center font-sans text-2xl font-medium text-gray-700 dark:text-white/90 lg:text-3xl">Shiyam Sarker</h2>
                        <p className="font-sans text-gray-500 dark:text-white/70">@_sarkerXx</p>
                    </div>
                    ...
                    <div>
                        <button className="rounded-full border border-[#0d87f8] px-4 py-2 text-sm text-[#0d87f8] duration-300 hover:bg-[#0d87f8]  hover:text-white dark:hover:bg-transparent dark:hover:text-[#0d87f8] dark:hover:drop-shadow-[0px_0px_2px_#0d87f8]">
                            SEND MESSAGE
                        </button>
                    </div>
                </div>
