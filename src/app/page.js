...
import ThemeSwitch from '@/ui/Client';
            ...
            <div className="z-10 flex justify-center py-6 text-center sm:py-10 md:py-14 lg:py-16 xl:py-20">
                <div className="space-y-5 sm:space-y-7">
                    ...
                    <p className="mx-auto text-balance text-sm font-medium dark:text-white sm:text-base md:text-lg  lg:text-xl xl:text-2xl">
                        Navigate to a world of <span className="text-sky-400">free</span>, <span className="text-sky-400">reusable</span>, and highly <span className="text-sky-400">customizable</span>{' '}
                        Tailwind components
                    </p>
