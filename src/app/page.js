    ...
    <div>
      <div className="flex flex-col items-center justify-center px-4 pb-8 pt-14 text-center md:px-8 md:py-28 ">
        ...
        <p className="mt-4 max-w-[500px] text-base font-medium  text-gray-400 md:text-lg">
          Navigate to a world of <span className="text-[#0095FF]">free</span>, <span className="text-[#0095FF]">reusable</span>, and highly <span className="text-[#0095FF]">customizable</span>{' '}
          Tailwind components
        </p>
