...
const Skeleton = () => {
    return (
        <div className="grid grid-cols-1 space-y-10">
            ...
            <>
                <h1 className="m-0 px-3 py-0  text-base font-bold italic underline opacity-70 sm:text-lg md:text-xl ">Product Details loading skeleton</h1>
                <Skeleton4></Skeleton4>
            </>
            <>
                <h1 className="m-0 px-3 py-0  text-base font-bold italic underline opacity-70 sm:text-lg md:text-xl">Ecommerce Card Skeleton</h1>
                <Skeleton2></Skeleton2>
            </>
            <>
                <h1 className="m-0 px-3 py-0  text-base font-bold italic underline opacity-70 sm:text-lg md:text-xl">Ecommerce Card Skeleton</h1>
            ...
            <>
                <h1 className="m-0 px-3 py-0  text-base font-bold italic underline opacity-70 sm:text-lg md:text-xl">Social media post skeleton</h1>
                <Skeleton5></Skeleton5>
            </>
            <>
                <h1 className="m-0 px-3 py-0  text-base font-bold italic underline opacity-70 sm:text-lg md:text-xl">Social media post skeleton</h1>
