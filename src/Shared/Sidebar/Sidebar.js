...
const navComponentsItems = ['Avatar', 'Accordion', 'Button', 'Carousel', 'Card', 'Form', 'Footer', 'Hero', 'Modal', 'NavBar','Progress', 'Speed Dial','Badge', 'Skeleton', 'Spinner', 'Table', 'Tooltip', 'Input'];
const Navbar = () => {
