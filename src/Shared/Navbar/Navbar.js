...
export default async function Navbar() {
  ...
  return (
    <nav className="borde relative z-[99] border-b-sky-500 bg-transparent text-white shadow-[0px_1px_4px_#0EA5E9] backdrop-blur-[1px]">
      <div className="item-center mx-auto flex max-w-[1500px] justify-between px-10 py-4">
        <Link href="/" className="flex items-center text-xl font-bold text-sky-500">
          <Image src="/Logo.svg" alt="navigateui logo" width={40} height={40} />
          NavigateUI
        </Link>
