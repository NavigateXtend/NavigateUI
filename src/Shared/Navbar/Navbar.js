        ...
        <ul className="flex items-center justify-center gap-3">
          <li>
            <Link className="group relative flex items-center gap-2" href="https://github.com/mhlehri/NavigateUI" target="_blank">
              <div className="flex items-center justify-center gap-1 rounded-lg bg-white p-1 text-sm text-black">
                <svg className="w-4 shadow-sm" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g strokeWidth="0"></g>
              ...
              <svg className="h-6 w-6" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#38BDF8">
                <g strokeWidth="0"></g>
                <g strokeLinecap="round" strokeLinejoin="round"></g>
                <g>
              ...
              <div className="invisible absolute -bottom-8 cursor-pointer whitespace-nowrap duration-200 group-hover:visible group-hover:duration-300">
                <p className="rounded-md bg-[#0EA5E9] px-3 py-1 text-xs text-white">Give a star</p>
              </div>
            </Link>
          </li>
          <li>
            <Link className="group relative flex items-center justify-center" href="https://discord.com/invite/ezphnpnEXx" target="_blank">
              ...
              <div className="invisible absolute -bottom-8 cursor-pointer whitespace-nowrap duration-200 group-hover:visible group-hover:duration-300  ">
                <p className="rounded-md bg-[#0EA5E9] px-3 py-1 text-xs text-white">Join our community</p>{' '}
              </div>
            </Link>
          </li>
        </ul>
