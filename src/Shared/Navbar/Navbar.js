    ...
    return (
        <nav className="relative z-[99] border-b bg-transparent backdrop-blur-md">
            <div className="item-center mx-auto flex max-w-7xl justify-between py-4">
                ...
                <ul>
                    <li>
                        <svg className="h-8 w-8" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <title>github [#000000]</title> <desc>Created with Sketch.</desc> <defs> </defs>{' '}
