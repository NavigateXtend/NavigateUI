  ...
  return (
    <div className=" mx-auto max-w-[1200px] rounded-lg bg-slate-950 p-6 text-white">
      ...
      <div className="mt-10 flex flex-wrap items-center gap-10">
        ...
        {/* Avatar 3 */}
        <div className="group relative">
          <Image width={60} height={60} className="h-[80px] w-[80px] rounded-full border-2 border-blue-300 bg-slate-500 object-cover" src="https://source.unsplash.com/300x300/?profile" alt="avatar" />
