...
export const SqureCardPagination = () => {
    ...
    return (
     <div className='flex justify-center items-center gap-3 bg-white p-2 shadow-lg rounded-md w-fit mx-auto'>
        {/* left arrow */}
...
export default SqureCardPagination;