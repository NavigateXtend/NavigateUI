...
<button className="text-xl w-32 h-16 before:absolute before:block before:inset-0 before:-z-10 before:bg-sky-500 text-white after:block hover:after:w-full after:w-0 after:hover:left-0 after:right-0 after:top-0 after:h-full after:-z-10 after:duration-300 after:bg-sky-900 after:absolute relative inline-block">Button</button>`}
            >
                <div className="flex flex-wrap items-center justify-evenly gap-4">
                    ...
                    <button className="group relative z-10 h-16 w-48 overflow-hidden bg-sky-950 text-xl text-white duration-700 hover:text-sky-900">
                        Button
...
<button type="button" className="py-2 px-5 w-40 h-16 text-sky-700 overflow-hidden shadow-lg border-sky-700 before:block before:absolute before:translate-x-[90%] before:inset-0 before:bg-sky-700 before:hover:translate-x-0 before:duration-300 before:rounded-s-full before:-z-10 after:-z-10 after:rounded-e-full after:duration-300 after:hover:translate-x-0 after:block after:absolute after:-translate-x-[90%] after:inset-0  after:bg-sky-700 relative inline-block hover:text-white">Submit</button>`}
            >
                <div className="flex flex-wrap items-center justify-evenly gap-4">
                    ...
                    {/* 11 */}
                    <button type="button" className="group relative h-14 w-48 overflow-hidden border-2 border-sky-950 text-xl text-sky-950 hover:text-sky-200">
                        <span className="absolute -left-2 bottom-0 top-0  -z-10 w-[57%] -translate-x-full skew-x-12 bg-sky-950 duration-300 ease-in group-hover:translate-x-0"></span>
                        <span className="absolute -right-2 bottom-0 top-0  -z-10 w-[55%] translate-x-full skew-x-12 bg-sky-700 duration-300 ease-in group-hover:translate-x-0"></span>
                        Button
                    </button>
                    {/* 12 */}
                    <button
                        type="button"
                        className="relative inline-block h-16 w-40 overflow-hidden border-sky-700 px-5 py-2 text-sky-700 shadow-lg before:absolute before:inset-0 before:-z-10 before:block before:translate-x-[90%] before:rounded-s-full before:bg-sky-700 before:duration-200 after:absolute after:inset-0 after:-z-10 after:block after:-translate-x-[90%] after:rounded-e-full after:bg-sky-700 after:duration-500 hover:text-white before:hover:translate-x-0 after:hover:translate-x-0"
                    >
                        Submit
                    </button>
                </div>
