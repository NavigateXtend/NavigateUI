            ...
            >
                <div className="flex flex-wrap items-center justify-evenly gap-4">
                    ...
                    <button className="group flex items-center justify-center overflow-hidden bg-sky-600 text-lg font-bold text-white">
                        ...
                        <span className="relative inline-block bg-sky-900 px-[10px] py-4 duration-500 after:absolute after:inset-0 after:flex after:translate-y-full after:items-center after:justify-center after:bg-sky-400 after:content-['N'] group-hover:-translate-y-full">
                            X
                        </span>
                        <span className="relative inline-block bg-sky-900 px-[10px] py-4 duration-500 after:absolute after:inset-0 after:flex after:-translate-y-full after:items-center after:justify-center after:content-['I'] group-hover:translate-y-full">
                            P
                        </span>
                        <span className="relative inline-block bg-sky-900 px-[10px] py-4 duration-500 after:absolute after:inset-0 after:flex after:translate-y-full after:items-center after:justify-center after:bg-sky-400 after:content-['F'] group-hover:-translate-y-full">
                            L
                        </span>
                        <span className="relative inline-block bg-sky-900 px-[10px] py-4 duration-500 after:absolute after:inset-0 after:flex after:-translate-y-full after:items-center after:justify-center after:content-['Y'] group-hover:translate-y-full">
                            O
                        </span>
                        <span className="relative inline-block bg-sky-900 px-[10px] py-4 duration-500 after:absolute after:inset-0 after:flex after:translate-y-full after:items-center after:justify-center after:bg-sky-400 after:content-['U'] group-hover:-translate-y-full">
                            R
                        </span>
                        <span className="relative inline-block bg-sky-900 px-[10px] py-4 duration-500 after:absolute after:inset-0 after:flex after:-translate-y-full after:items-center after:justify-center after:content-['I'] group-hover:translate-y-full">
                            E
...
`}
            >
                <div className="flex flex-wrap items-center justify-evenly gap-4">
                    ...
                    <button
                        type="button"
                        className="mx-auto flex items-center justify-center gap-3 rounded-none bg-transparent  from-[#58bfff] to-[#01bea5] p-2  text-black outline  outline-2  delay-75  ease-linear hover:scale-105    hover:bg-gradient-to-tr hover:text-white  hover:outline-none lg:p-3"
                    >
                        Explore
                    </button>
                </div>
