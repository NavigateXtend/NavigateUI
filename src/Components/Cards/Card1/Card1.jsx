        ...
        <CodeBox codeStr={codeStr}>
            <div className="mx-auto my-10 flex max-w-[350px] flex-col items-center justify-center space-y-4 rounded-xl bg-white p-8 font-sans shadow-lg">
                <div className="relative h-[120px] w-[120px]">
                    <img src="https://source.unsplash.com/120x120/?portrait" alt="portrait" className="h-full w-full rounded-full bg-black/30" />
                    <span className="absolute bottom-4 right-0 h-[25px] w-[25px] rounded-full border-2 border-white bg-white">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50" fill="#2AC07B">
                ...
                <button className="t w-[80%] rounded-full py-2 text-gray-400 shadow-[0px_0px_10px_#E2DADA]   duration-500 hover:bg-[#31B6BF] hover:text-white hover:shadow-xl">View Profile</button>
            </div>
        </CodeBox>
    );
};
