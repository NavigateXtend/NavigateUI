        ...
        <CodeBox codeStr={codeStr}>
            <div className="mx-auto my-20 flex flex-col items-center justify-center md:flex-row">
                <div className="group relative sm:w-[350px]">
                    <img className="h-full w-full scale-105 transform rounded-lg bg-black/70" src="https://source.unsplash.com/350x350/?men" alt="img" />
                    ...
                    <span className="absolute right-2 top-4 z-20 rounded-full bg-[#0d87f8] px-4 py-1  text-sm text-white shadow-[0px_0px_5px_0px_#0d87f8]">pro</span>
                    <span className="absolute left-0 top-3   z-20 rounded-full  text-sm text-white">
                        <svg width={30} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g id="Menu / Menu_Alt_03">
                                    <path id="Vector" d="M5 17H13M5 12H19M5 7H13" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                </g>
                            </g>
                        </svg>
                    </span>
                </div>
                <div className="min-w-[250px] max-w-[350px] space-y-12 rounded-br-lg rounded-tr-lg p-10 text-center shadow-[0px_7px_30px_2px_rgba(100,100,111,0.2)] md:w-[350px]">
                    <div className="space-y-1">
                        <h2 className="text-center font-sans text-2xl font-medium text-gray-700 lg:text-3xl">Dima Bolver</h2>
                        <p className="font-sans  text-gray-500">@dimablover</p>
                    </div>
