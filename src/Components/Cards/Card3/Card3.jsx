...
const Card3 = () => {
  const codeStr = `export const Card3 = () => {
  return (
...
`;
  return (
    <CodeBox codeStr={codeStr}>
      <div className="max-w-[350px] my-20 mx-auto shadow-md py-8 pl-8 rounded-lg border-t border-l border-l-[#005eb6] border-t-[#005eb6] border-b-2 border-r-2 border-b-[#0084ff] border-r-[#0084ff] space-y-6">
        <div className="flex justify-between items-center">
