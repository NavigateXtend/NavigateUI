      ...
      <div className="p-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 my-20">
        <div className="flex justify-between">
          <div className="flex items-center gap-2">
            <svg className="hover:fill-red-500 fill-[#c5c5C7]" width={20} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ cursor: "pointer" }}><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M2 9.1371C2 14 6.01943 16.5914 8.96173 18.9109C10 19.7294 11 20.5 12 20.5C13 20.5 14 19.7294 15.0383 18.9109C17.9806 16.5914 22 14 22 9.1371C22 4.27416 16.4998 0.825464 12 5.50063C7.50016 0.825464 2 4.27416 2 9.1371Z"></path></g></svg>
        ...
        <div className="flex items-center justify-center gap-6">
          <button className="px-4 py-2 rounded-lg bg-[#03CC9C] text-white font-semibold font-sans">Buy now</button>
...
`;
    return (
        <CodeBox codeStr={codeStr}>
            <div className="mx-auto my-20 max-w-[350px] space-y-6 rounded-xl p-8 font-sans shadow-lg">
                <div className="flex  justify-between">
                    <div className="flex items-center gap-2">
                        <svg className="fill-[#c5c5C7] hover:fill-red-500 " width={20} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ cursor: 'pointer' }}>
                    ...
                    <button className="rounded-xl bg-orange-600 px-2 py-1 text-white">30% off</button>
                </div>
                <div className="flex h-48 w-full justify-center lg:h-[280px]">
                    <img className="h-full w-full rounded-lg bg-black/40" src="https://source.unsplash.com/300x300/?smartwatch" alt="img" />
                </div>
                <div className="mx-auto w-[85%] space-y-2 text-center font-semibold">
                    ...
                    <p className="text-xs font-semibold text-gray-400 md:text-sm">Smart watches</p>
                </div>
                <div className="flex flex-wrap items-center justify-center gap-6 text-sm md:text-base">
                    <button className="rounded-lg bg-[#03CC9C] px-4 py-2 font-sans font-semibold text-white">Buy now</button>
                    <button className="flex items-center ">
