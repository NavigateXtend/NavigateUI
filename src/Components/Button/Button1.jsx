...
const Button1 = () => {
  return (
    <div className="flex flex-col items-start justify-center gap-5">
      <CodeBox
        codeStr={`
<button className="text-xl w-32 h-16 bg-sky-700 hover:scale-95 text-white duration-300">Button</button>
...
`}
      >
        <div className="flex w-full flex-wrap items-center justify-evenly gap-4">
          {/* 4,5,6 */}
          <button className="group relative z-10 h-16 w-32 overflow-hidden bg-black text-xl text-white">
          ...
          <button className="group relative z-50 h-16 w-32 overflow-hidden border-y-4 border-sky-950 bg-sky-700 text-xl text-white duration-500">
            Button
            <span className="absolute inset-0 z-10 flex items-center justify-center text-white opacity-0 duration-100 ease-out group-hover:opacity-100 group-hover:duration-1000">Leave</span>
