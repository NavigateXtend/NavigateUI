        ...
        <div className="flex flex-wrap items-center justify-evenly gap-4">
          ...
          <button>
            <label htmlFor="play" className="group relative flex size-10 cursor-pointer items-center justify-center">
              ...
              <span className="absolute right-0 top-0 h-[5px] w-full bg-sky-700 duration-300 group-hover:bg-sky-400 peer-checked/play:w-8 peer-checked/play:translate-y-[9px] peer-checked/play:-rotate-[45deg]"></span>
              <span className="absolute right-0 h-full w-[5px] bg-sky-700 duration-300 group-hover:bg-sky-400 peer-checked/play:h-[50px] peer-checked/play:-translate-x-[3px]"></span>
              <span className="absolute bottom-0 right-0 h-[5px] w-full bg-sky-700 duration-300 group-hover:bg-sky-400 peer-checked/play:w-8 peer-checked/play:-translate-y-[9px] peer-checked/play:rotate-[45deg]"></span>
            </label>
          </button>
          <button>
