                    ...
                    <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700 relative">
                        <div className="p-4 sm:p-7">
                            <div className="text-center">
                                {/* close signup page and redirect home icon  */}
                                <a href="#">
                                ...
                                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    <a href="#" className="text-[#FC7081] decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" to="/login">
                                        Login here
                                    </a>
                                </p>
                            </div>
