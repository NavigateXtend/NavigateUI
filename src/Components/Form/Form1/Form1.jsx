...
const codeStr = `const Form1 = () => {
    return (
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl border  font-sans">
            ...
            <form action="" className="space-y-6">
                <div className="space-y-1 text-sm">
                    ...
                    <input type="text" name="username" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border border-black/10 bg-slate "/>
                </div>
                <div className="space-y-1 text-sm">
                    <label htmlFor="password" className="block ">
                        Password
                    </label>
                    <input type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border border-black/10 bg-slate-50  "/>
                    <div className="flex justify-end text-xs ">
                        <a rel="noopener noreferrer" href="#">Forgot Password?</a>
                    </div>
                </div>
                <button className="block w-full p-3 text-center bg-black text-white rounded-sm   font-semibold">Sign in</button>
            </form>
