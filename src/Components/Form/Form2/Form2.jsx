                    ...
                    <form className="space-y-4">
                        <div className="flex sm:flex-row flex-col gap-4">
                            <div className="space-y-2">
                                ...
                                <input
                                    className="flex h-10 w-full px-3 py-2 text-sm hover:ring hover:outline-none focus:outline-none bg-gray-100  border border-gray-300  rounded-md"
                                    id="first-name"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                className="flex w-full px-3 py-2 text-sm  hover:ring hover:outline-none focus:outline-none  bg-gray-100  border border-gray-300  rounded-md min-h-[100px]"
                                id="message"
