...
export const Modal2 = () => {
    ...
    return (
            <div className="w-72 mx-auto flex items-center justify-center">
                ...
                <div className={\`absolute flex justify-center items-center z-[100] \${openModal ? 'visible opacity-1' : 'invisible opacity-0'} inset-0 backdrop-blur-sm bg-black/20 duration-100\`}>
