    ...
    <CodeBox codeStr={codeStr}>
      <div className="mx-auto flex w-72 items-center justify-center">
        ...
        <div
          ...
          className={`fixed z-[1000] flex items-center justify-center ${openModal ? 'visible opacity-100' : 'invisible opacity-0'} inset-0 h-full w-full bg-black/20 backdrop-blur-sm duration-100`}
        >
          <div
