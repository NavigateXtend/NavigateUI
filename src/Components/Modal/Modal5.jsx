      ...
      <div className="flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            {/* image */}
            <Image width={800} height={600} src="https://source.unsplash.com/800x600/?profile" className="min-h-[200px] min-w-[300px] bg-black/20 md:min-h-[350px] md:min-w-[500px]" alt="profile" />
