        ...
        <CodeBox codeStr={codeStr}>
            <div className="flex items-center flex-wrap justify-around">
                <div className="relative group">
                    <img className="w-[80px] h-[80px] object-cover rounded-full" src="https://source.unsplash.com/300x300/?profile" alt="" />
                ...
                <div className="relative group">
                    <img className="w-[110px] h-[110px] object-cover rounded-full" src="https://source.unsplash.com/300x300/?profile" alt="" />
                ...
                <div className="relative group">
                    <img className="w-[130px] h-[130px] object-cover rounded-full" src="https://source.unsplash.com/300x300/?profile" alt="" />
