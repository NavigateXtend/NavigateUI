    ...
    return (
        <div className="flex items-center flex-wrap justify-around my-20" id="_AvatarWithEditIcon_NavigateUI">
            <div className="relative group">
                <img className="size-[80px] border-2 border-blue-300 bg-slate-500 object-cover rounded-full" src="https://source.unsplash.com/300x300/?profile" alt="" />
            ...
            <div className="relative group">
                <img className="size-[110px] border-2 border-blue-300 bg-slate-500 object-cover rounded-full" src="https://source.unsplash.com/300x300/?profile" alt="" />
            ...
            <div className="relative group">
                <img className="size-[130px] border-2 border-blue-300 bg-slate-500 object-cover rounded-full" src="https://source.unsplash.com/300x300/?profile" alt="" />
  ...
  return (
    <CP code={code}>
      <div className="flex w-full flex-wrap items-center justify-evenly">
        ...
        <div className="group relative">
          <Image width={110} height={110} className="size-[110px] rounded-full border-2 border-blue-300 bg-slate-500 object-cover" src="https://source.unsplash.com/300x300/?profile" alt="avatar" />
        ...
        <div className="group relative">
          <Image width={130} height={130} className="size-[130px] rounded-full border-2 border-blue-300 bg-slate-500 object-cover" src="https://source.unsplash.com/300x300/?profile" alt="avatar" />
