  ...
  return (
    ...
    <CodeBox codeStr={codeStr}>
      <div className="flex flex-wrap items-center justify-around">
        <Image width={80} height={80} className="h-[80px] w-[80px] rounded-full bg-slate-500 object-cover duration-500 hover:blur-[2px]" src="https://source.unsplash.com/300x300/?profile" alt="" />
        <Image
          width={110}
          height={110}
