            ...
            <div className="flex items-center flex-wrap justify-around">
                ...
                <div className="relative group">
                    ...
                    <div className="h-5 w-5 bg-white absolute rounded-full bottom-2 right-0 border border-[#EB2B79] flex justify-center items-center ">
                        <svg width={14} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000<g id="SVGRepo_bgCarrier" strokeWidth="<g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="roun<g id= d="M9 18H15M12 13V21M12 13C14.7614 13 17 10.7614 17 8C17 5.23858 14.7614 3 12 3C9.23858 3 7 5.23858 7 8C7 10.7614 9.23858 13 strok strokeWidth= strokeLinejoin=><</g>
                        </svg>
                    </div>
                </div>
                {/* Medium Size  */}
