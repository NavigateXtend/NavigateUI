    ...
    <CodeBox codeStr={codeStr}>
      <div className="flex flex-wrap items-center justify-around">
        <div className="group relative">
          <Image width={80} height={80} className="h-[80px] w-[80px] rounded-full border-2 border-blue-300 bg-slate-500 object-cover" src="https://source.unsplash.com/300x300/?profile" alt="avatar" />
        ...
        <div className="group relative">
          <Image
            width={110}
            height={110}
            className="h-[110px] w-[110px] rounded-full border-2 border-blue-300 bg-slate-500 object-cover"
            src="https://source.unsplash.com/300x300/?profile"
            alt="avatar"
          />
          <div className="absolute right-0 top-2 flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 p-[3px] transition-all duration-500 group-hover:right-0 group-hover:top-0 group-hover:h-full group-hover:w-full group-hover:bg-blue-100/80">
        ...
        <div className="group relative">
          <Image
            width={130}
            height={130}
            className="h-[130px] w-[130px] rounded-full border-2 border-blue-300 bg-slate-500 object-cover"
            src="https://source.unsplash.com/300x300/?profile"
            alt="avatar"
          />
          <div className="absolute right-1 top-3 flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 p-[3px] transition-all duration-500 group-hover:right-0 group-hover:top-0 group-hover:h-full group-hover:w-full group-hover:bg-blue-100/80">
