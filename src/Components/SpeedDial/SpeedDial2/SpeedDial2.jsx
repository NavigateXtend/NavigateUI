...
const codeStr = `export const SpeedDial2 = () => {
    const svgs = [
    ...
    return (
        <div className="h-[400px] relative rotate-180">
                ...
                <div className="group flex flex-col items-center justify-center w-max mx-auto absolute top-0 left-[50%] -translate-x-1/2">
                    ...
                    <div className="space-y-4 duration-500 h-0 group-hover:my-4 group-hover:h-full ">
                        ...
                        {svgs?.map((svg, idx) => (
                            <div
                                key={idx}
                                className={`w-10 h-10 rotate-180 rounded-full scale-0 group-hover:scale-100 duration-300 shadow-[0px_2px_8px_0px_rgba(99,99,99,0.4)] opacity-0 group-hover:opacity-100 ${
                                    idx === 0
