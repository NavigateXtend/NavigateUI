                ...
                <div className="group absolute left-[50%] top-0 mx-auto flex w-max translate-x-1/2 flex-col items-center justify-center">
                    ...
                    <div className="h-0 space-y-4 duration-500 group-hover:my-4 group-hover:h-full ">
                        ...
                        {svgs?.map((svg, idx) => (
                            <div
                                key={idx}
                                className={`flex h-10 w-10 scale-0 items-center justify-center rounded-full bg-slate-50 opacity-0 shadow-[0px_2px_8px_0px_rgba(99,99,99,0.4)] duration-300 hover:bg-slate-200 group-hover:scale-100 group-hover:opacity-100 ${
                                    idx === 0
