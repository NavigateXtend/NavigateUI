...
export const SpeedDial1 = () => {
    return (
        <CodeBox codeStr={codeStr}>
            <div className="group flex flex-col-reverse items-center gap-4 w-max mx-auto">
                {/* icon container  */}
                <div className="space-y-4 p-4 transition-all duration-700 h-max">
                    {/* icon 1 */}
                    <div className="flex justify-center items-center w-10 h-10 bg-slate-50 rounded-full scale-0 group-hover:scale-100 duration-300 shadow-[0px_2px_8px_0px_rgba(99,99,99,0.4)] delay-[400ms] group-hover:delay-100 opacity-0 group-hover:opacity-100">
