    ...
    return (
        <CodeBox codeStr={codeStr}>
            ...
            >
                ...
                {/* slider container */}
                <div className="absolute -right-5 z-50 ml-auto w-[47%] items-center overflow-hidden px-4 py-10 md:-right-16 md:flex lg:-right-32">
                    <div className="flex items-center gap-[4%] duration-300 ease-linear" style={{ transform: `translateX(-${currentSlider * 48}%)` }}>
                        {/* sliders */}
                        {sliders.map((slide, inx) => (
                            <img
                                key={inx}
                                src={slide.img}
                                className={`h-[180px] min-w-[44%] sm:h-[200px] md:h-[320px] ${
