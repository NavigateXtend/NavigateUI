...
export const Slider3 = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto h-[540px] md:h-[670px] flex flex-col xl:flex-row items-center overflow-hidden gap-5 lg:gap-10 relative">
         ...
         {/* slider container */}
          <div className="h-[540px] md:h-[670px] w-2/3 ml-auto relative ease-linear duration-300 flex items-center gap-[%]" style={{ transform: \`translateX(-\${currentSlider * 50}%)\` }}>
            {/* sliders */}
            {sliders.map((slide, inx) => (<div key={inx} className={\`\${currentSlider === inx ? "h-[310px] md:h-[480px] lg:h-[580px]" : "h-[260px] md:h-[380px] lg:h-[480px] scale-95"} min-w-[50%] relative duration-200 \${currentSlider === inx ? "" : "opacity-40"}\`} style={{perspective: "200px",}}>
                 <img src={slide.img} className="w-full h-full bg-gray-900 rounded-lg duration-300" alt={slide.tags} style={{transform: \`\${currentSlider - 1 === inx ? "rotateX(0deg) rotateY(4deg)" : currentSlider + 1 === inx ? "rotateY(-4deg)" : ""}\`, transformStyle: "preserve-3d",}}/>
              </div>))}
          </div>
    </div>
  );
  ...
  return (
    <CodeBox codeStr={codeStr}>
      <div className="max-w-6xl mx-auto h-[540px] md:h-[670px] flex flex-col xl:flex-row items-center overflow-hidden gap-5 lg:gap-10 relative">
        ...
        {/* slider container */}
        <div
          className="h-[540px] md:h-[670px] w-2/3 ml-auto relative ease-linear duration-300 flex items-center gap-[%]"
