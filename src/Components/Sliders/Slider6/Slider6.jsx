      ...
      {/* map  */}
        ...
        {sliders.map((slide, idx) => (
          ...
          {/* main image  */}
            ...
            <img className={\`absolute bottom-5 border-white border-2 \${
                isOpen === idx
                  ? "left-4"
                  : "left-1/2 -translate-x-1/2 duration-700"
              }  h-[50px] w-[50px] object-cover rounded-full\`} src={slide.img} alt=""/>
      ...
      <div className="flex justify-center gap-1 md:gap-4">
        ...
        {sliders.map((slide, idx) => (
          <div
            ...
            className={`h-[600px] bg-gray-300 rounded-3xl relative duration-500 ease-in-out ${
          ...
          >
            ...
            <img
              className={`absolute bottom-5 border-white border md:border-2 ${
                isOpen === idx
                  ? "left-4"
                  : "left-1/2 -translate-x-1/2 duration-700"
              } h-[30px] md:h-[50px] w-[30] md:w-[50px] object-cover rounded-full`}
              src={slide.img}
              alt=""
            />
