              ...
              <div key={idx}>
                  <div onClick={() => handleToggle(idx)} className={\`\${idx === data.length - 1 ? 'border-none' : 'border-b border-gray-400/10'} flex items-center  gap-4 px-6 py-4\`}>
                      ...
                      <div className="flex-1">
                          ...
                          <p className="text-gray-400">{data?.subTitle} {/*give color based on condition */}<span className={\`\${idx === 0 ? 'text-[#0095FF]' : idx === 1 ? 'text-white' : idx === 2 ? 'text-amber-500' : idx === 3 ? 'text-[#CA1353]' : 'text-gray-500'}\`}>{data.coloredText}</span></p>
                      </div>
