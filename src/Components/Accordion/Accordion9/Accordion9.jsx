             ...
             <div className="mx-auto flex min-h-[300px] w-fit gap-1">
                {accordionData.map((_, idx) => (
                    <div key={idx} className="flex">
                        ...
                        {/* container */}
                        <div className={\`grid place-content-center rounded-lg bg-gray-200 shadow-md \${isActive === idx ? 'opacity-1 scale-1 w-56 px-5' : 'w-0 scale-0 opacity-0'} ml-2 text-black duration-300 ease-in-out\`}>
