                    ...
                    <div className={\`grid overflow-hidden transition-all duration-300 ease-in-out  \${isActive === idx ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}\`}>
                        <div className="overflow-hidden">
                            {accordionData[idx].subTitle?.map((subData, irx) => (
                                <div key={irx} className="w-full border-l-4 border-white py-4 pl-16 pr-4 text-gray-400 transition-all duration-500 hover:border-[#03BF70] hover:bg-green-100 hover:text-black">
                                    hello {irx + 1}
                                </div>
                            ))}
                        </div>
