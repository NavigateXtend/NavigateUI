...
const codestr = `
<div className="max-w-[370px] h-[270px] mx-auto bg-gradient-to-r from-blue-600 to-blue-400 rounded-xl p-8 shadow-lg relative transform rotate-3 hover:scale-105 hover:rotate-0 transition-transform duration-300">
...
const Card14 = () => {
    return (
        <CodeBox codeStr={codestr}>
            <div className="relative mx-auto h-[270px] max-w-[370px] rotate-3 transform rounded-xl bg-gradient-to-r from-blue-600 to-blue-400 p-8 shadow-lg transition-transform duration-300 hover:rotate-0 hover:scale-105">
                <div className="absolute -right-10 -top-5  h-44 w-44 rounded-full bg-white opacity-10" />
                <div className="absolute -bottom-8 -right-10 h-44 w-44 rounded-full bg-white opacity-10" />
                {/* user name and master card logo */}
                <div className="flex justify-between">
                    <div>
                        <div className="text-sm text-[#F6FFFF]">Name</div>
