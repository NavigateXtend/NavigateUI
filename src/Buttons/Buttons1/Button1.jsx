...
const Button1 = () => {
  return (
    <>
      ...
      {/* 9 */}
      <button className="text-3xl w-32 h-16 before:absolute before:block before:inset-0 before:-z-10 before:bg-teal-500 text-white after:block hover:after:w-full after:w-0  after:hover:left-0 after:right-0 after:top-0 after:h-full after:-z-10 after:duration-300 after:bg-teal-900 after:absolute relative inline-block">
        Hover
      </button>
      {/* 10 */}
